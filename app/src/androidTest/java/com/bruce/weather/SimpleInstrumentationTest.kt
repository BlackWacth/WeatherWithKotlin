...
import com.bruce.weather.ui.activity.MainActivity
...
class SimpleInstrumentationTest {
    ...
    fun itemClick_navigatesToDetail() {
        onView(withId(R.id.forecast_list)).perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(0, click()))
